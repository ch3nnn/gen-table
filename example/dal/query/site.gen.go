...
func (s *site) WithContext(ctx context.Context) ISiteDo { return s.siteDo.WithContext(ctx) }

func (s site) TableName() string { return s.siteDo.TableName() }

func (s site) Alias() string { return s.siteDo.Alias() }

func (s site) Columns(cols ...field.Expr) gen.Columns { return s.siteDo.Columns(cols...) }
